...
import base64
from PicmeClient import PicmeClient
import binascii
...
class MainApp:
    def __init__(self, username):
        ...
        self.root = tk.Tk()
        self.root.title("Picme Main App")
